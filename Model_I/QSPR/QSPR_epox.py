...
def select_features(mol_descriptors_target):
    ...
    df['Correlation threshold (ee)'] = [i*0.01 for i in range(100)]
    ...
    plt.savefig('../Data/Scatter Plot of Number of Features vs Correlation Threshold.pdf', bbox_inches='tight')  # Display the plot
...
if __name__ == "__main__":
    ...
    data = prepare_data('../Data/QSPR_epoxidation_model_I.xlsx')
